        ...
        <div class="container">
            ...
            <div class="col">
                <div id="head" class="row border-top pt-4 pb-3 font-weight-bold text-center">
                    ...
                    <div class="col">Warehouse PEC</div>
                    <div class="col">Warehouse Rama2</div>
                ...
                <div id="inslist">
                    <div class="row py-2 font-weight-bold border mb-2 rounded text-center"  style="background: #f4f4f4;">
                        <div class="col">1</div>
                        <div class="col-2">UPS12-1000 MRXF</div>
                        <div class="col">50</div>
                        <div class="col">0</div>
                        <div class="col-2">48</div>
                        <div class="col-2">
                            <button class="btn btn-info p-0 px-1" type="button">View</button>
                        </div>
                    </div>
                    <div class="row py-2 font-weight-bold border mb-2 rounded text-center"  style="background: #f4f4f4;">
                        <div class="col">1</div>
