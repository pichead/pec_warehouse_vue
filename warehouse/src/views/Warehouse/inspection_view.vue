                ...
                <div class="row">
                    <div class="col-6 my-1">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input readonly id="shipper_exporter" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 my-1">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input readonly id="inspection_no" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 my-1">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input readonly id="packing_list" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 my-1">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input readonly id="warehouse_location" type="text" class="form-control" required>
                            </div>
                        </div>
                    </div>
                            ...
                            for(let k = 0;k < po_select_data.data().battorder[i].ordersheet[j].battery.length; k++){
                                ...
                                $('#data').append(
                                    '<tr id="row_'+po_select_data.data().battorder[i].ordersheet[j].battery[k].batt_no+'">'+
                                        ...
                                        '<td>'+
                                            '<input id="qtydata_'+po_select_data.data().battorder[i].ordersheet[j].battery[k].batt_no+'" class="col-12 form-control" type="number" step="1" value="'+inspection_data.data().battery[x].qty+'" readonly/>'+
                                        '</td>'+
                        ...
                        for(let k = 0;k < po_select_data.data().battorder[i].ordersheet[j].battery.length; k++){
                            ...
                            $('#data').append(
                                '<tr id="row_'+po_select_data.data().battorder[i].ordersheet[j].battery[k].batt_no+'">'+
                                    ...
                                    '<td class="text-center"><div id="warrantydata_'+po_select_data.data().battorder[i].ordersheet[j].battery[k].batt_no+'" class="col-form-label">'+(parseInt(po_select_data.data().warranty)/12)+'</div></td>'+
                                    '<td>'+
                                        '<input id="qtydata_'+po_select_data.data().battorder[i].ordersheet[j].battery[k].batt_no+'" class="col-12 form-control" type="number" step="1" value="'+po_select_data.data().battorder[i].ordersheet[j].battery[k].order_amount+'" />'+
                                    '</td>'+
